...
OI::OI() {
    ...
    button_b.reset(new frc::JoystickButton(f310.get(), 1));
    button_b->WhileHeld(new CubeOut());
    button_A.reset(new frc::JoystickButton(f310.get(), 1));
    button_A->WhileHeld(new CubeIn());
    xbox.reset(new frc::Joystick(1));
    
    square.reset(new frc::JoystickButton(xbox.get(), 1));
    square->WhileHeld(new CubeOut());
    circle.reset(new frc::JoystickButton(xbox.get(), 1));
    circle->WhileHeld(new CubeIn());
    joystick.reset(new frc::Joystick(0));
    
    button_thumb.reset(new frc::JoystickButton(joystick.get(), 1));
